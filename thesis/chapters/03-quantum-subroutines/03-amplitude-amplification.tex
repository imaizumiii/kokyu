...
を生成するとする．
測定で得られる状態を二つに分ける．
目的の条件を満たすものを\textbf{良い状態}，
条件を満たさないものを\textbf{悪い状態}という．
良い状態の線形結合全体への射影を$\Pi_{\mathrm{g}}$とし，
...
良い状態か悪い状態かを判定する量子回路を用いる．
このような判定用の回路をオラクルという．このオラクルを使って，
良い状態の符号だけを反転する演算子を
\begin{equation}
  S_{\mathrm{g}}
  \coloneq
...
\end{align*}
と作用する．
したがって，$S_{\mathrm{g}}$は良い状態の符号だけを反転する．
二次元の図で考えると，これは悪い状態の方向を軸とする反射である．
...
成功確率を大きくするには，$(2r+1)\theta$が$\pi/2$に近くなるように$r$を選ぶ．
したがって，必要な反復回数はおよそ
\begin{equation}
  r
  \simeq
